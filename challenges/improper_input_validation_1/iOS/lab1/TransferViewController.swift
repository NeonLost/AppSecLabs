...
class TransferViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource  {
    ...
    @IBAction func onTransferButtonClick(_ sender: Any) {
        ...
        Alamofire.request("https://appseclabs.ru/lab2/transfer", method: .post, parameters: params)
    ...
    func updateUI() {
        ...
        Alamofire.request("https://appseclabs.ru/lab2/info", method: .post, parameters: params)
            .responseJSON { response in
                if let result = response.result.value {
                    let json = result as! NSDictionary
                    if json.object(forKey: "error") != nil {
