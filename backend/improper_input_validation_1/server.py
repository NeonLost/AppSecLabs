...
@improper_input_validation_1.route('/challenges/improper_input_validation_1/reg', methods=['GET', 'POST'])
def register():
    try:
...
@improper_input_validation_1.route('/challenges/improper_input_validation_1/auth', methods=['GET', 'POST'])
def auth():
    login = request.values.get('login')
    password = request.values.get('password')
...
@improper_input_validation_1.route('/challenges/improper_input_validation_1/info', methods=['GET', 'POST'])
def info():
...
@improper_input_validation_1.route('/challenges/improper_input_validation_1/transfer', methods=['GET', 'POST'])
def transfer():
    token = request.values.get('token')
